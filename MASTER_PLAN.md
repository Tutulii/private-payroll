...
4. Add private wage-claim and remediation circuits plus `CLAIM` and `REMEDIATE` state transitions. The historical-fact, claimant, nullifier, unit and remediation bindings must satisfy [`docs/WAGE_CLAIM_BINDING_PLAN.md`](./docs/WAGE_CLAIM_BINDING_PLAN.md) before this item can be complete.
