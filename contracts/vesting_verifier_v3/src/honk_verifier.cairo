...
use super::honk_verifier_circuits::{
    is_on_curve_excluding_infinity_bn254, run_GRUMPKIN_ZKHONK_PREP_MSM_SCALARS_SIZE_20_circuit,
    run_GRUMPKIN_ZK_HONK_EVALS_CONS_DONE_SIZE_20_circuit,
    run_GRUMPKIN_ZK_HONK_EVALS_CONS_INIT_SIZE_20_circuit,
    run_GRUMPKIN_ZK_HONK_EVALS_CONS_LOOP_SIZE_20_circuit,
    run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_20_PUB_74_circuit,
};
...
mod PayoVestingBookV3Verifier {
    ...
    use super::{
        ...
        run_GRUMPKIN_ZKHONK_PREP_MSM_SCALARS_SIZE_20_circuit,
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_DONE_SIZE_20_circuit,
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_INIT_SIZE_20_circuit,
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_LOOP_SIZE_20_circuit,
        run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_20_PUB_74_circuit, vk,
    };
    ...
    impl IUltraKeccakZKHonkVerifier of super::IUltraKeccakZKHonkVerifier<ContractState> {
        fn verify_ultra_keccak_zk_honk_proof(
            ...
            let (sum_check_rlc, honk_check) = run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_20_PUB_74_circuit(
            ...
            } // log_n -1 = 19 points || Proof points 10-28
            for lib_comm in full_proof.proof.libra_commitments {
                _points.append((*lib_comm).into());
            } // 3 points || Proof points 29-31
            _points.append(full_proof.proof.kzg_quotient.into()); // Proof point 32
            ...
            let mut scalars: Span<u384> = array![
                ...
                scalar_58, scalar_59, transcript.shplonk_z.into(), scalar_60,
            ]
                .span();

            // Check input points are on curve.
            // Skip the first 28 points as they are from VK and keep the last 32 proof points
            for point in points.slice(28, 32) {
                assert(
            ...
            assert(msm_hint.len() == 61 * 12, 'wrong glv&fakeglv hint size');
