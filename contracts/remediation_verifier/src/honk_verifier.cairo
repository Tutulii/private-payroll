...
use super::honk_verifier_circuits::{
    ...
    run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_16_PUB_33_circuit,
};
...
#[starknet::contract]
mod PayoWageRemediationVerifier {
    ...
    use super::{
        ...
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_INIT_SIZE_16_circuit,
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_LOOP_SIZE_16_circuit,
        run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_16_PUB_33_circuit, vk,
    };
    ...
    impl IUltraKeccakZKHonkVerifier of super::IUltraKeccakZKHonkVerifier<ContractState> {
        fn verify_ultra_keccak_zk_honk_proof(
            ...
            let (sum_check_rlc, honk_check) = run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_16_PUB_33_circuit(
