...
export type PayrollToken = {
  ...
  address: string;
  decimals: number;
  feeBehavior: "deduct-from-strk-shield" | "public-strk-reserve";
...
export const PAYROLL_TOKENS: Record<PayrollTokenSymbol, PayrollToken> = {
  STRK: {
    ...
    decimals: 18,
    feeBehavior: "deduct-from-strk-shield",
    privacyEnabled: true,
  },
  USDC: {
    symbol: "USDC",
    ...
    decimals: 6,
    feeBehavior: "public-strk-reserve",
    privacyEnabled: process.env.NEXT_PUBLIC_ENABLE_EXPERIMENTAL_USDC === "true",
  },
};
